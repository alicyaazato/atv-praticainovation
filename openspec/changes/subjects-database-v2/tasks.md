...
**Acceptance Criteria**:
- [ ] Table exists in Xano with all fields
- [ ] Primary key and indexes configured
- [ ] Foreign key constraints working
- [ ] Auto-timestamps functional
...
**Acceptance Criteria**:
- [ ] INSERT trigger created and tested
- [ ] UPDATE trigger captures changes
- [ ] DELETE trigger logs deletion
- [ ] Events properly captured in event_logs
- [ ] Event payloads include required details
...
- [ ] Endpoints accept and return correct JSON
...
**Acceptance Criteria**:
- [ ] Owner can read/modify their subjects
- [ ] Members can only access their subjects
- [ ] Admins can access all account subjects
- [ ] Unauthorized access returns 403
- [ ] All endpoints validate permissions
- [ ] 404 returned instead of 403 to prevent leaks
